...
//		},	
		methods:{
			fetchData(id){
				var _this = this;
				this.$http.get('../src/data/article.data?time=new Date()').then(function(res){
...
<style scoped>
	...
	#p1{line-height:.45rem;margin-bottom:.1rem;text-indent:2em;margin:10px;}
